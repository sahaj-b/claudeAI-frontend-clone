function Button({ value, tooltip, tooltip_direction = "bottom", onClick_function, extraClass }) {
  ...
  return (
    <div className="group relative inline-block">
      <button className={`text-text1 px-2 py-1 text-sm font-bold hover:transition-all hover:bg-bg4 hover:text-white transition-all rounded-lg ${extraClass}`} onClick={onClick_function}>{value}</button>
